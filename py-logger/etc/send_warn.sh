...
#
 ...
 python3 ../send_nrdp.py -u http://localhost/nrdp/ -t ${TOKEN} -H raspberrypi -c 1 -s refrig-116-sensor-logger -S 1 -o "${DT},refrig-116,refrig,116,WARNING: Danger refrigerator alert in room 116"
 echo $?
#